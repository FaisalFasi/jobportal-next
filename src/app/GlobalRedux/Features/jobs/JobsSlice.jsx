  ...
  async (searchTerm) => {
    try {
      if (searchTerm === null || searchTerm === undefined) {
        // Return early if searchTerm is null or undefined
        return [];
      }
  ...
  async (loggedInUserId) => {
    try {
      if (loggedInUserId === null || loggedInUserId === undefined) {
        // Return early if loggedInUserId is null or undefined
        return [];
      }
...
export const createJob = createAsyncThunk("jobs/createJob", async (jobData) => {
  try {
    if (jobData === null || jobData === undefined) {
      // Return early if jobData is null or undefined
      return [];
    }
...
export const deleteJob = createAsyncThunk("jobs/deleteJob", async (jobData) => {
  try {
    if (
      ...
      jobData === undefined ||
      jobData.id === null ||
      jobData.id === undefined
    ) {
      // Return early if jobData or jobData.id is null or undefined
      return [];
    }
